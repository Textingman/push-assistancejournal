                  ...
                  <div className="rounded-lg p-6 text-white" style={{ backgroundColor: '#1F2937' }}>
                    <div className="flex items-start">
                      ...
                      <label htmlFor="sms-account-notifications" className="ml-3 text-sm leading-relaxed">
                        By checking this box and submitting this form, you agree to receive transactional account notification text messages from Assistance Journal. I understand I may opt out of SMS communication by replying 'STOP'. Reply HELP or email support@assistancejournal.com for help. Message and Data rates may apply. Message frequency varies. Carriers are not liable for delayed or undelivered messages. Opting in to SMS is optional and not required to submit this form. All messages will be handled by Assistance Journal.
                      </label>
                    </div>
                  </div>
                  ...
                  <div className="rounded-lg p-6 text-white" style={{ backgroundColor: '#1F2937' }}>
                    <div className="flex items-start">
                      ...
                      <label htmlFor="sms-customer-care" className="ml-3 text-sm leading-relaxed">
                        By checking this box and submitting this form, you agree to receive <strong>customer care</strong> text messages from Assistance Journal. I understand I may opt out of SMS communication by replying 'STOP'. Reply HELP or email support@assistancejournal.com for help. Message and Data rates may apply. Message frequency varies. Carriers are not liable for delayed or undelivered messages. Opting in to SMS is optional and not required to submit this form. All messages will be handled by Assistance Journal.
                      </label>
                    </div>
                  </div>
