          ...
          <div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <a
                  href="mailto:support@assistancejournal.com"
              ...
              <div>
                ...
                <p style={{ color: '#6B7280' }}>
                  Assistance Journal<br />
                  6102 Cherrylawn Cir<br />
                  Austin, TX 78723
                </p>
              </div>
              ...
              <div>
                ...
                <p style={{ color: '#6B7280' }}>
                  ...
                  <a href="mailto:support@assistancejournal.com" className="font-medium hover:underline" style={{ color: '#1E40AF' }}>
                    support@assistancejournal.com
                  </a>.
          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-sm" style={{ color: '#6B7280' }}>
                  Reply <strong>HELP</strong> to any SMS message or email us at support@assistancejournal.com.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm" style={{ color: '#6B7280' }}>
                  ...
                  <a href="/privacy" className="font-medium hover:underline" style={{ color: '#1E40AF' }}>Privacy Policy</a> for full details.
                </p>
              </div>
